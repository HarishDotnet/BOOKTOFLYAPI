...
namespace BookToFlyAPI.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddTicket([FromBody] TicketInputDTO ticketRequest)
        {
            var flightDetails = await _dbContext.flightDetails.FirstOrDefaultAsync(f => f.FlightNumber == ticketRequest.FlightNumber);
        ...
        {
            var tickets = await _dbContext.tickets.Where(t => t.Username == username).ToListAsync();
